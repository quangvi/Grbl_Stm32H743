...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 1000.0 //250.0 mm
  #define DEFAULT_Y_STEPS_PER_MM 1000.0 //250.0 mm
  #define DEFAULT_Z_STEPS_PER_MM 1000.0 //250.0 mm
  #ifdef USER_MORE_AXIS
    #define DEFAULT_A_STEPS_PER_MM 1000.0 //250.0 mm
      #ifdef USER_6_AXIS
        #define DEFAULT_B_STEPS_PER_MM 1000.0 //250.0 mm
        #define DEFAULT_C_STEPS_PER_MM 1000.0 //250.0 mm
        #ifdef USER_8_AXIS
          #define DEFAULT_D_STEPS_PER_MM 1000.0 //250.0 mm
          #define DEFAULT_E_STEPS_PER_MM 1000.0 //250.0 mm
        #endif
      #endif
  #endif //USER_MORE_AXIS
  #ifdef STM32H743xx
    #define DEFAULT_X_MAX_RATE 24000.0 //500.0 // mm/min
    #define DEFAULT_Y_MAX_RATE 24000.0 //500.0 // mm/min
    #define DEFAULT_Z_MAX_RATE 24000.0 //500.0 // mm/min
    #ifdef USER_MORE_AXIS
      #define DEFAULT_A_MAX_RATE 24000.0 //500.0 // mm/min
      #ifdef USER_6_AXIS
        #define DEFAULT_B_MAX_RATE 24000.0 //500.0 // mm/min
        #define DEFAULT_C_MAX_RATE 24000.0 //500.0 // mm/min
        #ifdef USER_8_AXIS
          #define DEFAULT_D_MAX_RATE 24000.0 //500.0 // mm/min
          #define DEFAULT_E_MAX_RATE 24000.0 //500.0 // mm/min
        #endif
      #endif
    #endif //USER_MORE_AXIS
    #define DEFAULT_X_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
    #define DEFAULT_Y_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
    #define DEFAULT_Z_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
    #ifdef USER_MORE_AXIS
      #define DEFAULT_A_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
      #ifdef USER_6_AXIS
        #define DEFAULT_B_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
        #define DEFAULT_C_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
        #ifdef USER_8_AXIS
          #define DEFAULT_D_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
          #define DEFAULT_E_ACCELERATION (800.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
        #endif
      #endif
    #endif //USER_MORE_AXIS
  #else
    #define DEFAULT_X_MAX_RATE 12500.0 //500.0 // mm/min
    #define DEFAULT_Y_MAX_RATE 12500.0 //500.0 // mm/min
    #define DEFAULT_Z_MAX_RATE 12500.0 //500.0 // mm/min
	#ifdef USER_MORE_AXIS
      #define DEFAULT_A_MAX_RATE 7500.0 //500.0 // mm/min
    #endif //USER_MORE_AXIS
    #define DEFAULT_X_ACCELERATION (1000.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
    #define DEFAULT_Y_ACCELERATION (1000.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
    #define DEFAULT_Z_ACCELERATION (1000.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
    #ifdef USER_MORE_AXIS
      #define DEFAULT_A_ACCELERATION (200.0*60*60) //(10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
    #endif //USER_MORE_AXIS
  #endif

  #define DEFAULT_X_MAX_TRAVEL 1000.0 //200.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 1000.0 //200.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 1000.0 //200.0 // mm NOTE: Must be a positive value.
  #ifdef USER_MORE_AXIS
    #define DEFAULT_A_MAX_TRAVEL 1000.0 //200.0 // mm
      #ifdef USER_6_AXIS
        #define DEFAULT_B_MAX_TRAVEL 1000.0 //200.0 // mm
        #define DEFAULT_C_MAX_TRAVEL 1000.0 //200.0 // mm
        #ifdef USER_8_AXIS
          #define DEFAULT_D_MAX_TRAVEL 1000.0 //200.0 // mm
          #define DEFAULT_E_MAX_TRAVEL 1000.0 //200.0 // mm
        #endif
      #endif
  #endif //USER_MORE_AXIS
  ...
  #ifdef STM32H743xx
    #define DEFAULT_STEP_PULSE_MICROSECONDS 2//1.25 //
  #else
    #define DEFAULT_STEP_PULSE_MICROSECONDS 2 //10
  #endif
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK 7
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 //25 // msec (0-254, 255 keeps steppers enabled)
  #ifdef USE_CLASSIC_GRBL_INTERFACE
    #define DEFAULT_STATUS_REPORT_MASK ((BITFLAG_RT_STATUS_MACHINE_POSITION)|(BITFLAG_RT_STATUS_WORK_POSITION))//1 // MPos enabled
  #else
  ...
  #ifdef USER_MORE_AXIS
    #define DEFAULT_HOMING_DIR_MASK 15 // move negative dir// 0b1111
  #else //not USER_MORE_AXIS
    #define DEFAULT_HOMING_DIR_MASK 7 // move negative dir//0 // move positive dir
  #endif //USER_MORE_AXIS
  ...
  #ifdef USER_BACKLASH
    #define DEFAULT_X_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_X_ACCELERATION
    #define DEFAULT_Y_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_Y_ACCELERATION
    #define DEFAULT_Z_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_Z_ACCELERATION

    #define DEFAULT_X_BACKLASH_MM 5.0 //mm
    #define DEFAULT_Y_BACKLASH_MM 5.0 //mm
    #define DEFAULT_Z_BACKLASH_MM 5.0 //mm
    #ifdef USER_MORE_AXIS
      #define DEFAULT_A_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_A_ACCELERATION

      #define DEFAULT_A_BACKLASH_MM 5.0 //mm
      #ifdef USER_6_AXIS
        #define DEFAULT_B_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_A_ACCELERATION
        #define DEFAULT_C_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_B_ACCELERATION

        #define DEFAULT_B_BACKLASH_MM 5.0 //mm
        #define DEFAULT_C_BACKLASH_MM 5.0 //mm
        #ifdef USER_8_AXIS
          #define DEFAULT_D_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_C_ACCELERATION
          #define DEFAULT_E_BACKLASH_ACCELERATION (200.0*60*60) //DEFAULT_D_ACCELERATION

          #define DEFAULT_D_BACKLASH_MM 5.0 //mm
          #define DEFAULT_E_BACKLASH_MM 5.0 //mm
        #endif
      #endif
    #endif
  #endif //USER_BACKLASH
