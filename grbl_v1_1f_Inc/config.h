...
#define CMD_RAPID_OVR_LOW 0x97
  ...
  #define CMD_RAPID_OVR_HIGH 0x98
#endif
...
#define HOMING_CYCLE_1 ((1<<X_AXIS)|(1<<Y_AXIS))  // OPTIONAL: Then move X,Y at the same time.
  ...
  #ifdef USER_6_AXIS
    #ifdef USER_8_AXIS
      #define HOMING_CYCLE_2  ((1<<A_AXIS)|(1<<B_AXIS)|(1<<C_AXIS)|(1<<D_AXIS)|(1<<E_AXIS))                       // OPTIONAL: Uncomment and add axes mask to enable
    #else
      #define HOMING_CYCLE_2  ((1<<A_AXIS)|(1<<B_AXIS)|(1<<C_AXIS))                       // OPTIONAL: Uncomment and add axes mask to enable
    #endif
  #else
...
#ifdef USER_STM32
  #define RAPID_OVERRIDE_HIGH    75 // Percent of rapid (1-99). Usually 50%.
#endif
...
#ifdef USER_STM32
  //move to Extern_Variables_functions.h
#else //USER_STM32
