...
void report_grbl_settings() {
  ...
  #ifdef USER_STM32
    printFloat(settings.pulse_microseconds, 1);
  #else
  ...
  for (set_idx=0; set_idx<AXIS_N_SETTINGS; set_idx++) {
    for (idx=0; idx<N_AXIS; idx++) {
      ...
      switch (set_idx) {
        ...
        #ifdef USER_BACKLASH
          case 4: printFloat(settings.backlash_mm[idx],N_DECIMAL_SETTINGVALUE); break;
          #ifdef USER_ACC_BACKLASH
            case 5: printFloat(settings.backlash_acceleration[idx]/(60*60),N_DECIMAL_SETTINGVALUE); break;
          #endif
        #endif
      }
      serial_write(' ');
      ...
      switch (idx) {
        ...
        case Z_AXIS: printPgmString(PSTR("z")); break;
            ...
            #ifdef USER_8_AXIS
              case D_AXIS: printPgmString(PSTR("d")); break;
      ...
      switch (set_idx) {
        ...
        #ifdef USER_BACKLASH
          case 4: printPgmString(PSTR(" backlash, mm")); break;
          case 5: printPgmString(PSTR(" accel_bl, mm/sec^2")); break;
        #endif
      }
      printPgmString(PSTR(")\r\n"));
    }
  ...
  for (set_idx=0; set_idx<AXIS_N_SETTINGS; set_idx++) {
    for (idx=0; idx<N_AXIS; idx++) {
      switch (set_idx) {
        ...
        #ifdef USER_BACKLASH
          case 4: report_util_float_setting(val+idx,settings.backlash_mm[idx],N_DECIMAL_SETTINGVALUE); break;
          #ifdef USER_ACC_BACKLASH
            case 5: report_util_float_setting(val+idx,settings.backlash_acceleration[idx]/(60*60),N_DECIMAL_SETTINGVALUE); break;
          #endif
        #endif
      }
    }
...
#ifdef USER_BACKLASH
  extern plan_block_backlash_t block_backlash;
#endif
