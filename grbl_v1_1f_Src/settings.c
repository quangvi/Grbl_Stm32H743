...
void settings_restore(uint8_t restore_flag) {
  if (restore_flag & SETTINGS_RESTORE_DEFAULTS) {
    ...
    #ifdef USER_BACKLASH
      settings.backlash_mm[X_AXIS] = DEFAULT_X_BACKLASH_MM;
      settings.backlash_mm[Y_AXIS] = DEFAULT_Y_BACKLASH_MM;
      settings.backlash_mm[Z_AXIS] = DEFAULT_Z_BACKLASH_MM;
      #ifdef USER_ACC_BACKLASH
        settings.backlash_acceleration[X_AXIS] = DEFAULT_X_BACKLASH_ACCELERATION;
        settings.backlash_acceleration[Y_AXIS] = DEFAULT_Y_BACKLASH_ACCELERATION;
        settings.backlash_acceleration[Z_AXIS] = DEFAULT_Z_BACKLASH_ACCELERATION;
      #endif
      #ifdef USER_MORE_AXIS
        settings.backlash_mm[A_AXIS] = DEFAULT_A_BACKLASH_MM;
        #ifdef USER_6_AXIS
          settings.backlash_mm[B_AXIS] = DEFAULT_B_BACKLASH_MM;
          settings.backlash_mm[C_AXIS] = DEFAULT_C_BACKLASH_MM;
          #ifdef USER_8_AXIS
            settings.backlash_mm[D_AXIS] = DEFAULT_D_BACKLASH_MM;
            settings.backlash_mm[E_AXIS] = DEFAULT_E_BACKLASH_MM;
          #endif
        #endif
        #ifdef USER_ACC_BACKLASH
          settings.backlash_acceleration[A_AXIS] = DEFAULT_A_BACKLASH_ACCELERATION;
          #ifdef USER_6_AXIS
            settings.backlash_acceleration[B_AXIS] = DEFAULT_B_BACKLASH_ACCELERATION;
            settings.backlash_acceleration[C_AXIS] = DEFAULT_C_BACKLASH_ACCELERATION;
            #ifdef USER_8_AXIS
              settings.backlash_acceleration[D_AXIS] = DEFAULT_D_BACKLASH_ACCELERATION;
              settings.backlash_acceleration[E_AXIS] = DEFAULT_E_BACKLASH_ACCELERATION;
            #endif
          #endif
        #endif
    ...
    while (set_idx < AXIS_N_SETTINGS) {
      if (parameter < N_AXIS) {
        ...
        switch (set_idx) {
          ...
          #ifdef USER_BACKLASH
            case 4: settings.backlash_mm[parameter] = value; break;
            #ifdef USER_ACC_BACKLASH
              case 5: settings.backlash_acceleration[parameter] = value*60*60; break;
            #endif
          #endif
        }
...
void settings_init() {
  ...
  {
    #ifdef USER_MORE_AXIS
       return (LimitBitSimulateArray[axis_idx]);
    #else //not USER_MORE_AXIS
      if ( axis_idx == X_AXIS ) { return(X_LIMIT_PIN_INDEX); }
      if ( axis_idx == Y_AXIS ) { return(Y_LIMIT_PIN_INDEX); }
      return((Z_LIMIT_PIN_INDEX));
    #endif //USER_MORE_AXIS
  }
#else //not USER_STM32
  // Returns step pin mask according to Grbl internal axis indexing.
