...
uint8_t gc_execute_line(char *line)
{
        ...
        switch(letter){
          ...
          case 'Z': word_bit = WORD_Z; gc_block.values.xyz[Z_AXIS] = value; axis_words |= (1<<Z_AXIS); break;
            ...
            case 'A': word_bit = WORD_A; gc_block.values.xyz[A_AXIS] = value; axis_words |= (1<<A_AXIS); break;
              ...
              #endif
            #endif
          //            case 'O': word_bit = WORD_O; gc_block.values.ijk[A_AXIS] = value; ijk_words |= (1<<A_AXIS); break;
  ...
  */
  ...
  #ifdef USER_MORE_AXIS
    axis_linear[1] = A_AXIS;
    #ifdef USER_6_AXIS
      axis_linear[2] = B_AXIS;
      axis_linear[3] = C_AXIS;
      #ifdef USER_8_AXIS
        axis_linear[4] = D_AXIS;
        axis_linear[5] = E_AXIS;
      #endif
    #endif
  #endif //USER_MORE_AXIS
  ...
  if (gc_parser_flags & GC_PARSER_JOG_MOTION) {
    ...
    bit_false(value_words,(bit(WORD_N)|bit(WORD_F)|bit(WORD_S)|bit(WORD_T))); // Remove single-meaning value words.
      ...
      #ifdef USER_6_AXIS
        #ifdef USER_8_AXIS
          if (axis_command) { bit_false(value_words,(bit(WORD_X)|bit(WORD_Y)|bit(WORD_Z)|bit(WORD_A)|bit(WORD_B)|bit(WORD_C)|bit(WORD_D)|bit(WORD_E))); } // Remove axis words.
        #else
